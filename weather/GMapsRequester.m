...
- (void)processGeocodeResponseWithResponseDictionary:(id)responseDictionary
                                     completionBlock:(void (^)(GeoLocation *))completionBlock {
    NSArray *geocodeList = responseDictionary[@"results"];
    GeoLocation *locCoordinates = [[GeoLocation alloc] initWithDictionary:[geocodeList firstObject]];
